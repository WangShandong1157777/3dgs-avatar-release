...
def load_model(gender='neutral', use_cuda=True, model_type='smpl', skel_type='body25', device=None, model_path='body_models', model_file=None):
    # prepare SMPL model
    ...
    if model_type == 'smpl':
        ...
        #     regressor_path=None)
        body_model = SMPLlayer(model_file, gender=gender, device=device, regressor_path=None)
    else:
        body_model = None
